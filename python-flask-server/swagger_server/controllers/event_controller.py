...
def event_id_allocations_entity_type_entity_id_post(eventId, entityType, entityId, allocation):  # noqa: E501
    ...
    :type entityId: str
    :param allocation: The actual allocation.
    :type allocation: list | bytes

    :rtype: EntityAllocationResponse
    """
    if connexion.request.is_json:
        allocation = [EntityAllocation.from_dict(d) for d in connexion.request.get_json()]  # noqa: E501
